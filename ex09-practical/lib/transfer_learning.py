...
class ModifiedResNet4(ModifiedResNetBase):
    def __init__(self):
        ...
        saved_conv = self.resnet.layer4[1].conv2
        self.resnet.layer4[1].conv2 = nn.Conv2d(
            in_channels=saved_conv.in_channels,
            out_channels=saved_conv.out_channels,
            kernel_size=saved_conv.kernel_size,
            stride=saved_conv.stride,
            padding=saved_conv.padding,
            bias=saved_conv.bias is not None,
        )
        # END TODO #############
